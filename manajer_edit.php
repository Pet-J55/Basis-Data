...
if (!isset($_GET['id'])) {
    header("Location: manajer_users.php");
    exit;
}
...
if (isset($_POST['updateManajer'])) {
    ...
    if (empty($errors)) {
        ...
        if ($koneksi->query($sql)) {
            $success = "Data Manajer berhasil diperbarui!";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid py-4">
                <h1 class="mb-4 text-primary"><i class="fas fa-user-edit"></i> Edit Manajer</h1>
                <a href="manajer_users.php" class="btn btn-secondary mb-3">&laquo; Kembali</a>

                <!-- Card Form Edit -->
                <div class="card mb-4">
                    <div class="card-header">Form Edit Manajer</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <button type="submit" name="updateManajer" class="btn btn-success">Simpan Perubahan</button>
                        </form>
                    </div>
                </div>
